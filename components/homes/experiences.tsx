...
export default function Experience(){
  ...
  return(
    <div className="flex flex-col gap-4 mt-12 xl:mt-40 mb-24 mx-auto w-2/3">
            ...
            {myExperiences.map((exp, index) => {
              return (
                <li
                  ...
                  className={`flex border-b-2  md:border-l-2 md:border-b-0 p-4 font-sans hover:text-blue hover:border-blue ${exp.id === work.id ? 'text-blue border-blue': 'text-gray border-gray/20'} transform hover:cursor-pointer`}
