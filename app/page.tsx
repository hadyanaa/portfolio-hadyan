...
export default function Home() {
  return (
    <main className="flex bg-primary min-h-screen flex-col justify-between px-8 xl:px-20">
      {/* landing hero */}
      <div className="flex flex-col xl:flex-row justify-center items-center gap-8 mt-12 xl:mt-40">
